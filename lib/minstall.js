...
function findOptimalDependencyTargetFolder() {
  ...
  return moduletools.getAllModulesAndInstalledDependenciesDeep()
    .then((result) => {
      ...
      // A dependency might still get shadowed, if a dependency has a supdependency that would shadow
      // another direct dependency. i need to think about how to solve this
